...
from app.mcp_firewall import redact_text_impl, DEFAULT_RULES, rules
...
class TestRedaction(unittest.TestCase):
    ...
    def test_ssn_redaction(self):
        ...
        result = redact_text_impl(text)
        self.assertEqual(result["redacted_text"], "My SSN is <SSN>")
    ...
    def test_credit_card_redaction(self):
        ...
        result = redact_text_impl(text)
        self.assertEqual(result["redacted_text"], "My credit card is <CREDIT_CARD>")
        self.assertEqual(len(result["matches"]), 1)
    ...
    def test_email_redaction(self):
        ...
        result = redact_text_impl(text)
        self.assertEqual(result["redacted_text"], "My email is <EMAIL>")
        self.assertEqual(len(result["matches"]), 1)
    ...
    def test_phone_redaction(self):
        ...
        result = redact_text_impl(text)
        self.assertEqual(result["redacted_text"], "My phone is <PHONE>")
        self.assertEqual(len(result["matches"]), 1)
    ...
    def test_multiple_redactions(self):
        ...
        result = redact_text_impl(text)
        self.assertEqual(result["redacted_text"], "My SSN is <SSN> and my email is <EMAIL>")
